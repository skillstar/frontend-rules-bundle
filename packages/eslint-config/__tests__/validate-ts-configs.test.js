...
describe('Validate TS configs', () => {
  it('Validate frb-eslint-config/typescript', async () => {
  ...
  it('Validate frb-eslint-config/typescript/vue', async () => {
  ...
  it('Validate frb-eslint-config/essential/typescript', async () => {
  ...
  it('Validate frb-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate frb-eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate frb-eslint-config/typescript/node', async () => {
