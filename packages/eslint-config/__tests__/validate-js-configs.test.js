...
describe('Validate JS configs', () => {
  it('Validate frb-eslint-config', async () => {
  ...
  it('Validate frb-eslint-config/es5', async () => {
  ...
  it('Validate frb-eslint-config/vue', async () => {
  ...
  it('Validate frb-eslint-config/essential', async () => {
  ...
  it('Validate frb-eslint-config/essential/es5', async () => {
  ...
  it('Validate frb-eslint-config/essential/react', async () => {
  ...
  it('Validate frb-eslint-config/essential/vue', async () => {
  ...
  it('Validate frb-eslint-config/node', async () => {
